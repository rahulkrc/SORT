...
class Index
{
	...
	Index()
	{
		try
		{
			...
			oos.writeObject("PEER_GROUP_2_LOGIN");
			oos.writeObject(ip);
...
class RunPeer extends Thread implements ActionListener
{
	...
	public void run()
	{
		JFrame j=new JFrame("PEER_GROUP_2_"+peer_no);
		...
		JLabel jl=new JLabel("PEER_GROUP_2_"+peer_no);
		...
		j.setLocation(d.width/6,peer_no*75);
