	...
	public void run()
	{
		try
		{
			...
			for(int ii=1;ii<=apc;ii++)
			{
				...
				al.add(1,10.0f); 
				al.add(2,"ON");
				adj_peer_inf.put("P_G_3_"+Integer.toString(ii),al);
			}
			...
			while(true)
			{
				...
				System.out.println("");
				System.out.println("REQ "+req+" RECEIVED IN PEER_2 "+jj);
				if(req.equals("DATA"))
				{
					...
					try
					{
						...
						System.out.println("");
						System.out.println("Selected PEER "+"P_G_3_"+Integer.toString(nxt_peer+1));
						System.out.println("");
						...
						ArrayList al = (ArrayList)peer_info.get("P_G_3_"+Integer.toString(ii));
						...
						String peer="P_G_3_"+Integer.toString(ii);
						...
						if(flg)
						{
							...
							{
								int ij=i+1;
								ArrayList nu_al = (ArrayList)nu_peer_info.get("P_G_3_"+Integer.toString(ij));
				...
				else if(req.equals("STATUS"))
				{
					...
					ArrayList al = adj_peer_inf.get("P_G_3_"+peer);
					ArrayList nu_al = new ArrayList();
					nu_al.add(0,(Float)al.get(0));
					nu_al.add(1,(Float)al.get(1));
					nu_al.add(2,status);
					adj_peer_inf.put("P_G_3_"+peer,nu_al);
